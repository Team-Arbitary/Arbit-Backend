...
public class ImageAnalysisServiceImpl implements ImageAnalysisService {
    ...
    public void checkAndTriggerAnalysis(String inspectionNo, String transformerNo) {
        try {
            ...
            Optional<ImageInspect> baselineImage = imageInspectRepository
                    .findBaselineImageByTransformerNo(transformerNo);
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                try {
                    ...
                    log.error("Error saving analysis result for inspection {}: {}", inspectionNo, saveEx.getMessage(),
                            saveEx);
                ...
                resultImage.setUploadDate(
                        new java.text.SimpleDateFormat("EEE, MMM dd, yyyy hh:mm a").format(new java.util.Date()));
            ...
            try {
                ...
                log.error("Error saving failed analysis result for inspection {}: {}", inspectionNo,
    ...
    @Override
    public ApiResponse<List<AnalysisResult>> getAnalysisResultsByTransformer(String transformerNo)
    ...
    public String testStatusUpdate(String inspectionNo) throws BaseException {
        try {
            ...
            if (inspectionRecord.isPresent()) {
                ...
                inspectionRecordsRepository.save(record);
                log.info(
                        "Test: Updated inspection record status for inspection {} (found by: {}, record ID: {}) from '{}' to 'Completed'",
                        inspectionNo, foundBy, record.getId(), oldStatus);
                return String.format(
                        "SUCCESS: Updated record ID=%d (inspection_no='%s', found by: %s) from '%s' to 'Completed'",
