...
public class TransformerManagementController extends BaseController {
    ...
    @GetMapping("/view/{id}")
    public ResponseEntity<ApiResponse<TransformerRecords>> getTransformerById(@PathVariable String id, HttpServletRequest request) throws BaseException {
        long startTime = System.currentTimeMillis();
        log.info(LoggingAdviceConstants.REQUEST_INITIATED, request.getMethod(), request.getRequestURI());
    ...
    public ResponseEntity<ApiResponse<Void>> deleteTransformer(@PathVariable String id, HttpServletRequest request) throws BaseException {
        long startTime = System.currentTimeMillis();
        log.info(LoggingAdviceConstants.REQUEST_INITIATED, request.getMethod(), request.getRequestURI());
