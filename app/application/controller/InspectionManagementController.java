...
public class InspectionManagementController extends BaseController {
    ...
    @GetMapping("/view/{id}")
    public ResponseEntity<ApiResponse<InspectionRecords>> getInspectionById(@PathVariable String id,
                                                                            HttpServletRequest request) throws BaseException {
        long startTime = System.currentTimeMillis();
        log.info(LoggingAdviceConstants.REQUEST_INITIATED, request.getMethod(), request.getRequestURI());
    ...
    public ResponseEntity<ApiResponse<Void>> deleteInspection(@PathVariable String id, HttpServletRequest request) throws BaseException {
        long startTime = System.currentTimeMillis();
        log.info(LoggingAdviceConstants.REQUEST_INITIATED, request.getMethod(), request.getRequestURI());
